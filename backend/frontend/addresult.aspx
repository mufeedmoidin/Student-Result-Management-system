<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="addresult.aspx.cs" Inherits="addresult" %>
...
<table class="nav-justified">
    <tr>
        <td align="center" colspan="4" 
            ...
            style="padding: inherit; font-size: xx-large; color: #FF0000; text-decoration: underline; ; font-style: normal; font-weight: bold; font-family: 'Times New Roman', Times, serif;" 
            bgcolor=>
            SELECT CLASS TO ADD RESULT</td>
    </tr>
    <tr>
        <td>
            <br />
